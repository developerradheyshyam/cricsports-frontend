    ...
    return (
        <div className={`${urbanist.variable} font-urbanist  w-full   `}>
            <section className="min-h-screen mb-64 sm:mb-[35rem] relative pt-24 md:pt-40 ">
                <div className="wraper px-4 md:px-0    flex flex-col space-y-6  justify-center items-center z-auto text-white ">
                ...
                <div className="absolute   flex justify-center  -translate-x-1/2 left-1/2 -bottom-40 sm:-bottom-60 md:-bottom-[33rem]  w-full">
