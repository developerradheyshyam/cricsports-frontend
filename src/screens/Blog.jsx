  ...
  return (
    ...
    <div className="text-center mb-8">
      <h2 className="text-3xl md:text-4xl font-bold mb-4">
        Latest <span className={`${dmSerif.variable} font-dmSerif text-[#AB2735]  font-thin italic`}>News & Blogs</span>
      </h2>
      ...
      {blogPosts.map((post) => (
        <div key={post.id} className="flex justify-center flex-col items-center overflow-hidden h-[80vh] ">
          ...
          <div className="py-4 ">
            ...
            {/* Read More Button */}
            <button className="flex space-x-3 justify-center  items-center mt-4 p-4  py-3 border-[1px] border-red-600 text-[#AB2735]  font-thin rounded-lg hover:bg-red-600 hover:text-white transition-colors">
              <span> Read More</span>
              <span className='bg-[#AD020A] p-1 rounded-full'>

              <ArrowRight size={16} className=" z-10  text-white" />
              </span>
            </button>
          </div>
        </div>
